...
<style>
    ...
    /* Outer wrapper: relative positioning context so the shortcut
       can be pulled out of flow without affecting lp-container's centering */
    .data-recovery-container {
        position: relative;
    }

    /* Fixed the typo (was "data-recovery-shortuct") so this class actually
       matches the HTML element and position: absolute takes effect */
    .data-recovery-shortcut {
        position: absolute;
        top: 10px;
        left: -20px;
        max-width: 175px;
    ...
    .data-recovery-shortcut a:hover {
      text-decoration: underline;
      color: var(--fg-bright);
    }


    .data-recovery-shortcut p,
    .data-recovery-shortcut span {
      color: #bdae93;
      font-size: 0.85rem;
      margin: 0;
      line-height: 1.4;
    ...
    /* New wrapper to center the data recovery form independently,
       the same way lp-container centers itself */
    .data-recovery-form-wrapper {
        max-width: 1024px;
        margin: 30px auto 0 auto;
        text-align: center;
    }

    .data-recovery-form-wrapper iframe {
        max-width: 100%;
    }
...
<div class="data-recovery-container">
    ...
    <div id="data-recovery-form" class="data-recovery-form-wrapper">
        <iframe
            id="referralIframe"
            src="https://partner.fields-data-recovery.co.uk/referral-form/embed?account=TDNSc2Q3VGxqd2I2WXZtMmtRZlp5bW9VQWZYYkF1R0l5UWhZQ3dpTUovdz0%3D&cost_center=UK9&lead_website=https%3A%2F%2Fwww.fields-data-recovery.co.uk&color=%23f6921e&button_color=%230077ff&label_color=%23000000&input_border_color=%23dddddd&font_color=%23000000&background_color=%23ffffff&heading_font=Arial&body_font=Arial&button_font=Arial"
